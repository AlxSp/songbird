...
def get_sample_index_ranges(audio_events_arr, spectrogram, sample_time_dim, sampling_step_size, sampling_padding_size):
    ...
    spectrogram_sample_arr = np.array([spectrogram[:, start_index:end_index] for start_index, end_index in sample_slice_indices_arr])#cropped_spectrogram[:,sample_slice_indices_arr[:,0]:sample_slice_indices_arr[:,1]] # get the spectrogram slices
